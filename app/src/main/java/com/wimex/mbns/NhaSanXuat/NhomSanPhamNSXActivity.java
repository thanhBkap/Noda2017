...
public class NhomSanPhamNSXActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nhom_san_pham_nsx);
        addControls();
        addEvents();
    }
    ...
    public void onBackPressed() {
        Intent mMoveToTrangChuNSX = new Intent(NhomSanPhamNSXActivity.this,DanhMucSanPhamNSXActivity.class);
        mMoveToTrangChuNSX.putExtra("loaisanphamid",loaisanphamid);
    ...
    private void addControls() {
        ...
        nhomSanPhamNSXAdapter = new NhomSanPhamNSXAdapter(NhomSanPhamNSXActivity.this, R.layout.list_item_nhom_san_pham_nsx, listSanPham);
        ...
        postData.put("danhmucid",loaisanphamid);
            ...
            try {
                ...
                for (int i = 0; i < root.length(); i++) {
                    ...
                    if (data.getString("KhachHangId").equals(Auth.khachHangId)) {
                        if (data.getString("loaiSanPham").equals(loaisanphamid)) {
                            SanPham sp = new SanPham();
                            sp.setAnh(Auth.domain+"/images/" + data.getString("logoId") + ".jpg");
                            sp.setTen(data.getString("tenSanPham"));
                            sp.setDate(data.getString("date"));
                            sp.setPrice(Float.parseFloat(data.getString("giaSanPham")));
                            listSanPham.add(sp);
